...
export const Onboarding01Page = () => (
  <Onboarding01 />
)

export const Onboarding02Page = () => (
  <Onboarding02 />
)
...
export const Onboarding04Page = () => (
  <Onboarding04 />
)

export const Onboarding05Page = () => (
  <Onboarding05 />
)

export const Onboarding06Page = () => (
  <Onboarding06 />
)

export const Onboarding07Page = () => (
  <Onboarding07 />
)

export const Onboarding08Page = () => (
  <Onboarding08 />
)
